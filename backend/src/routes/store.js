...
const { createStore, getStore } = require("../controllers/store/createController.js");
...
const { addProduct, getProducts } = require("../controllers/store/proudctController.js");
const { toggleStock } = require("../controllers/store/stock-toggleController.js");
const router = Router();
