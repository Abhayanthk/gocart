...
const Hero = () => {
  ...
  return (
    <div className="mx-6">
      {/* Making flex-col for screens smaller than xl to avoid image overflow */}
      <div className="flex max-xl:flex-col gap-8 max-w-7xl mx-auto my-10">
        {/* Normaly when we hover: then only that element is effected but when put the parent element class as group then 
        we can use group-hover to effect the child when the parenet is hover */}
        <div className="relative flex-1 flex flex-col bg-green-200 rounded-3xl xl:min-h-100 group">
          ...
          {/* This make the image at the bottom right and locks the size of the image to max width small */}
          <Image
