...
const OurSpecs = () => {
    ...
    return (
        <div className='px-6 my-20 max-w-6xl mx-auto'>
            ...
            {/* Making  resposice grid layout with 1 column on small screens, 2 columns on medium screens and 3 columns on large screens  */}
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7 gap-y-10 mt-26'>
                {
                    ourSpecsData.map((spec, index) => {
                        return (
                              // we had to use style here because tailwind does not support dynamic colors
